          ...
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#solucion">
            <div class="card-body">
             <div class="col-md-12">   
               ...
               <form action="<?php echo base_url();?>ticketadmin/ticket/storesol" method="post">
                ...
                <div class="form-group">
                  ...
                  <textarea placeholder="Deje respuesta a la solucion de este ticket" type="text" id="mensaje" name="mensaje" class="form-control" rows="8"></textarea>
