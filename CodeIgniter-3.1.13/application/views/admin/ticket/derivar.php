            ...
            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#solucion">
              <div class="card-body">
                ...
                <div class="col-12">
                  ...
                  <textarea readonly="" type="text" class="form-control" rows="8">s<?php echo $Ticket->descripcion;?></textarea>
                </div>
          ...
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#solucion">
            <div class="card-body">
             <div class="col-md-12">   
               ...
               <form action="<?php echo base_url();?>ticketadmin/ticket/storederiv" method="post">
                ...
                <div class="form-group">
                  ...
                  <textarea placeholder="Deje respuesta a la derivación de este ticket" type="text" id="mensaje" name="mensaje" class="form-control" rows="8"></textarea>
